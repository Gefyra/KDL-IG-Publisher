...
* ^expansion.parameter[=].valueCode = #de
...
* ^expansion.contains[=].display = "Kostenübernahme"
* ^expansion.contains[+].system = "http://dvmd.de/fhir/CodeSystem/kdl"
...
* ^expansion.contains[+].system = "http://dvmd.de/fhir/CodeSystem/kdl"
* ^expansion.contains[=].code = #AM160114
* ^expansion.contains[=].display = "Anästhesieausweis"
* ^expansion.contains[+].system = "http://dvmd.de/fhir/CodeSystem/kdl"
...
* ^expansion.contains[+].system = "http://dvmd.de/fhir/CodeSystem/kdl"
* ^expansion.contains[=].code = #DG020116
* ^expansion.contains[=].display = "Zugangscode Bildportal"
* ^expansion.contains[+].system = "http://dvmd.de/fhir/CodeSystem/kdl"
...
* ^expansion.contains[+].system = "http://dvmd.de/fhir/CodeSystem/kdl"
* ^expansion.contains[=].code = #VL010109
* ^expansion.contains[=].display = "Sepsisdokumentation"
* ^expansion.contains[+].system = "http://dvmd.de/fhir/CodeSystem/kdl"
...
* ^expansion.contains[=].display = "Dokumentation vorhandener Infrastruktur"
* ^expansion.contains[+].system = "http://dvmd.de/fhir/CodeSystem/kdl"
