# ConceptMap zur Übersetzung von KDL-Codes in IHE-XDS DocumentEntry.classCodes - Kontext: Archivierung, inkl. eVV - Klinische Dokumentenklassen-Liste (KDL) v2026.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://dvmd.de/fhir/ConceptMap/kdl-ihe-classcode | *Version*:2026.1.0 |
...
```json
{
  ...
  "targetCanonical" : "http://ihe-d.de/ValueSets/IHEXDSclassCode|3.0.1",
  "group" : [{
    "source" : "http://dvmd.de/fhir/CodeSystem/kdl",
    "sourceVersion" : "2026.1.0",
