# ConceptMap zur Übersetzung von KDL-Codes in IHE-XDS DocumentEntry.typeCodes - Kontext: Archivierung, inkl. eVV - Klinische Dokumentenklassen-Liste (KDL) v2026.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://dvmd.de/fhir/ConceptMap/kdl-ihe-typecode | *Version*:2026.1.0 |
...
```json
{
  ...
  "targetCanonical" : "http://ihe-d.de/ValueSets/IHEXDStypeCode|3.0.1",
  "group" : [{
