# Home - Klinische Dokumentenklassen-Liste (KDL) v2026.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://dvmd.de/fhir/ImplementationGuide/dvmd.kdl.r4 | *Version*:2026.1.0 |
| Active as of 2026-08-11 | *Computable Name*:KDL |
...
Copyright: 2013-2018 DM GmbH & Co. KG seit 2018 DVMD e.V.
...
![](GefyralogosoloM_Claim_sehrklein.jpg)
...
```json
{
  ...
  "version" : "2026.1.0",
  "name" : "KDL",
  "title" : "Klinische Dokumentenklassen-Liste (KDL)",
  "status" : "active",
  "date" : "2026-08-11T16:39:26+00:00",
  ...
  "description" : "Das Package enthält die KDL im FHIR-Format für den Datenaustausch im Kontext der elektronischen Patientenakte. Die Zusammenstellung des FHIR Pakets basiert auf den Inhalten, die seitens DVMD e.V. zur Verfügung gestellt wurden.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://dvmd.de/fhir/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "CodeSystem-kdl.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/kdl"
      },
      "name" : "CodeSystem Klinische Dokumentenklassen-Liste 2026",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ConceptMap-kdl-ihe-classcode.html"
      }],
      "reference" : {
        "reference" : "ConceptMap/kdl-ihe-classcode"
      },
      "name" : "ConceptMap zur Übersetzung von KDL-Codes in IHE-XDS DocumentEntry.classCodes - Kontext: Archivierung, inkl. eVV",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ConceptMap-kdl-ihe-typecode.html"
      }],
      "reference" : {
        "reference" : "ConceptMap/kdl-ihe-typecode"
      },
      "name" : "ConceptMap zur Übersetzung von KDL-Codes in IHE-XDS DocumentEntry.typeCodes - Kontext: Archivierung, inkl. eVV",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-kdl.html"
      }],
      "reference" : {
        "reference" : "ValueSet/kdl"
      },
      "name" : "Dokumenten(typ)klassen Klinische Dokumentenklassen-Liste 2026",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "DocumentReference-kdl-dokref-ex-1.html"
      }],
      "reference" : {
        "reference" : "DocumentReference/kdl-dokref-ex-1"
      },
      "name" : "kdl-dokref-ex-1",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "DocumentReference-kdl-dokref-ex-2.html"
      }],
      "reference" : {
        "reference" : "DocumentReference/kdl-dokref-ex-2"
      },
      "name" : "kdl-dokref-ex-2",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-kdl-all.html"
      }],
      "reference" : {
        "reference" : "ValueSet/kdl-all"
      },
      "name" : "Klinische Dokumentenklassen-Liste 2026",
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "Aenderungen-zur-Vorversion.html"
        }],
        "nameUrl" : "Aenderungen-zur-Vorversion.html",
        "title" : "Aenderungen Zur Vorversion",
        "generation" : "markdown"
      }]
    },
    "parameter" : [{
